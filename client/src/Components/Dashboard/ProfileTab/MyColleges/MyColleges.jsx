...
const MyColleges = () => {
    ...
    const handleSubmitApplication = () => {
        // Assuming application submission logic goes here
        console.log("Submitting application for", selectedCourse);
        ...
        <div className="Grid2">
            ...
            <div className="HorizontalContainer">
                ...
                <div className="MiniTabs">
                    ...
                    <Link to='/MyColleges'><button className="MyColleges active">My Colleges</button></Link>
                ...
                {myColleges.map(college => (
                    <div key={college.id} className="mycollege-item">
                        ...
                        <div className="mycollege-details">
                            ...
                            <button className='Status'>View Status</button>
                        </div>
                    </div>
                ))}
                ...
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <form onSubmit={handleSubmitApplication}>
                            {documents.filter(doc => doc.highlighted).map(doc => (
                                <li key={doc.name}>{doc.name} <span className="checkmark">&#10003;</span></li>
                            ))}
                            <br></br>
